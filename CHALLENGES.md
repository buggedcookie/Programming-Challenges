...
|--------|---------------------|------------------------------------------------|
| ⬜ | Rock Paper Scissors  | Classic choice game with random logic        |
| ⬜ | Dice Simulator       | Simulate die rolls                            |
| ⬜ | Guess the Number     | User guesses a number                         |
| ⬜ | Number Guesser AI    | Computer guesses your number                  |
| ⬜ | Snake                | Classic game with movement, food, and growth |
| ⬜ | Breakout             | Paddle hits ball to break bricks              |
| ⬜ | Pong                 | Classic 2-player arcade game                  |
| ⬜ | Space Invaders       | Enemies descend, player shoots                |
| ⬜ | Tetris               | Falling blocks logic                          |
| ⬜ | Tower Defense        | Waves of enemies and strategic placement      |
| ⬜ | Maze Generator       | Create and solve mazes                        |
| ⬜ | Platformer Test      | Jumping, gravity, and side-scroll logic       |
...
|--------|------------------------|-------------------------------------------------|
| ⬜ | To-Do App              | Task list with persistence                    |
| ⬜ | Notes App              | Create/search/edit notes                      |
| ⬜ | Weather Dashboard      | Fetch & show forecast from API                |
| ⬜ | Budget Tracker         | Track expenses, show charts                   |
| ⬜ | Visual Calculator      | GUI calculator with history                   |
| ⬜ | Markdown Viewer       | Parse and show markdown                       |
| ⬜ | File Explorer          | Browse and manage files                       |
| ⬜ | Text Editor            | Edit and save files                           |
| ⬜ | RSS Reader             | Parse and read RSS feeds                      |
| ⬜ | Chat App               | Simple network chat                           |
| ⬜ | Web Scraper            | Scrape site data                              |

---

## 🧠 Language & Interpreter Projects

| Status | Project                      | Description                                           |
|--------|------------------------------|-------------------------------------------------------|
| ⬜ | My Own Data Format           | Design, parse, and save/load your own format         |
| ⬜ | Scripting Language (MyLang)  | Syntax, tokens, interpreter                          |
| ⬜ | Brainf\*ck Interpreter        | Build full BF interpreter                           |
| ⬜ | FizzBuzz in MyLang           | Prove your scripting language works!                 |
| ⬜ | Calculator in MyLang         | Evaluate expressions using your interpreter          |
| ⬜ | Snake in MyLang              | Build a game using your own language!                |
| ⬜ | Bytecode Interpreter         | Simulate low-level VM                                |
| ⬜ | Regex Engine (Mini)          | Match patterns without using built-in regex          |
| ⬜ | Terminal Shell               | Parse and run commands                               |
| ⬜ | Enigma Simulator             | Simulate the WWII cipher machine                     |
